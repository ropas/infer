...
val validate_opt_type :
  Ag_util.Validation.path -> opt_type -> Ag_util.Validation.error option
  (** Validate a value of type {!opt_type}. *)
...
val validate_previous_decl :
  Ag_util.Validation.path -> previous_decl -> Ag_util.Validation.error option
  (** Validate a value of type {!previous_decl}. *)
...
val create_compound_assign_operator_info :
  caoi_lhs_type: type_ptr ->
  caoi_result_type: type_ptr ->
...
val create_decl_info :
  ...
  ?di_previous_decl: previous_decl ->
...
val create_function_decl_info :
  ...
  ?fdi_decls_in_prototype_scope: decl list ->
...
val create_lambda_expr_info :
  ?lei_captures: lambda_capture_info list ->
